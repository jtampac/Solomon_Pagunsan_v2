...
```
solomon-pagunsan/
├── index.html  about.html  farm-learning.html  vlogs.html
├── gallery.html  partners.html  press.html  contact.html
...
- **Sidebar** — every editable section (Hero, About, Student Visits, Farm Crops,
  Workshop, Livestock, Vlogs, Gallery, Sponsors, Services, Media Kit, Press,
  Contact, Social & Links, Site/Footer, Announcements).
